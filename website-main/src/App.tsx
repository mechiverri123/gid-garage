...
const CALENDLY_URL = 'https://calendly.com/mechiverri123/book-a-service-appointment';
...
const services = [
  ...
  { title: 'Engine Repair', desc: 'From tune-ups to major engine repairs with expert precision.' },
  { title: 'Suspension', desc: 'Shocks, struts, and control arms for a smooth, stable ride.' },
  { title: 'A/C Repair', desc: 'Refrigerant service and compressor repair for Arizona heat.' },
  { title: 'Alignment', desc: 'Wheel alignment to extend tire life and improve handling.' },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 md:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        {/* Mobile hamburger */}
        <button
          className={`md:hidden p-1 transition-colors ${scrolled ? 'text-dark' : 'text-white'}`}
        ...
        <div className="md:hidden bg-white border-b border-gray-200 px-5 py-5 flex flex-col gap-4">
          {links.map((l) => (
            <a
              key={l.label}
              href={l.href}
              className="text-dark text-base font-semibold uppercase tracking-wide transition-colors hover:text-red-600"
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center bg-dark overflow-hidden pt-20">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=2560&q=85&auto=format&fit=crop"
          alt="Mechanic working under a car hood"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 md:px-8 text-center">
        ...
        <p className="text-red-400 text-xs font-bold uppercase tracking-[0.25em] mb-8">
        ...
        <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light">
          Honest pricing, expert technicians, fast turnaround. Your car deserves the best — and we deliver.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#booking" className="btn-primary text-sm px-8 py-4">
            Book an Appointment
          </a>
          <a href={`tel:${PHONE}`} className="btn-outline text-sm px-8 py-4">
    ...
    <section id="services" className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="text-center mb-12">
          <p className="text-red-600 text-xs font-bold uppercase tracking-[0.25em] mb-2">
            What We Offer
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s) => (
            <div
              key={s.title}
              className="p-6 bg-light border-l-4 border-red-600 hover:shadow-lg transition-shadow duration-300"
            >
              <h3 className="text-dark font-bold text-lg mb-2 tracking-tight">
                {s.title}
              </h3>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 text-sm mb-6">
            Don't see what you need? Call us — we handle virtually all automotive repair.
          </p>
          <a href={`tel:${PHONE}`} className="btn-primary inline-flex gap-2 items-center text-xs">
            <Phone className="w-4 h-4" />
            {PHONE}
          </a>
        </div>
...
function WhyUs() {
  return (
    <section id="why" className="py-20 md:py-28 bg-dark">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="text-center mb-12">
          <p className="text-red-400 text-xs font-bold uppercase tracking-[0.25em] mb-2">
            The GID Difference
          </p>
          <h2 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">
            Why Choose GID Garage?
          </h2>
        </div>
          ...
          {[
            {
              ...
              desc: 'Clear estimates, no hidden fees, no pressure to upsell. You always know what you\'re paying for.',
            },
            {
              title: 'Expert Technicians',
              desc: 'Our mechanics have years of hands-on experience with all makes and models.',
            },
            {
              title: 'Fast Turnaround',
              desc: 'Most services completed same-day so you\'re never left waiting.',
            },
          ].map((t) => (
            <div
              key={t.title}
              className="bg-white/5 border border-white/10 p-8 hover:border-red-600/30 hover:bg-white/10 transition-all duration-300"
            >
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-base">
            ...
            <a
              href={`tel:${PHONE}`}
              className="text-red-600 hover:text-red-700 font-semibold transition-colors underline underline-offset-2"
            >
              call {PHONE}
            </a>{' '}
        ...
        <div
          className="calendly-inline-widget bg-light border border-gray-200"
    ...
    <section className="bg-red-600 py-12">
      <div className="max-w-7xl mx-auto px-5 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="#booking"
            className="inline-flex items-center justify-center bg-white text-red-600 font-bold px-7 py-3 text-sm uppercase tracking-wide hover:bg-red-50 transition-colors duration-200"
          >
            Book Now
          </a>
          <a
            href={`tel:${PHONE}`}
            className="inline-flex items-center justify-center gap-2 border-2 border-white text-white font-bold px-7 py-3 text-sm uppercase tracking-wide hover:bg-white/10 transition-colors duration-200"
          >
            <Phone className="w-4 h-4" />
            {PHONE}
          </a>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm max-w-xs leading-relaxed">
              Professional automotive repair and service in Arizona. Honest work. Fair prices.
            </p>
          </div>
