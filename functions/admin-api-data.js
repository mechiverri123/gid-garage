    ...
    switch (action) {
      ...
      case 'send-estimate': {
        ...
        await brevoSend({
          ...
          htmlContent: `<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="background:#0f0f0f;"><tr><td align="center" bgcolor="#0f0f0f" style="background:#0f0f0f;padding:0;"><table width="560" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="font-family:sans-serif;max-width:560px;width:100%;background:#0f0f0f;color:#fff;overflow:hidden;"><img src="https://gidgarage.com/banner.PNG" alt="GID Garage" style="width:100%;display:block;height:auto;"/><div style="padding:28px 32px 32px;"><h2 style="color:#fff;font-size:22px;margin:0 0 8px;">Your Estimate is Ready</h2><p style="color:#9ca3af;margin:0 0 20px;">Hi ${job.fname}, here's your quote for the upcoming appointment.</p><table style="width:100%;border-collapse:collapse;margin-bottom:8px;">${lineItemsHtml}</table><table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
      ...
      case 'send-invoice': {
        ...
        await brevoSend({
          ...
          htmlContent: `<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="background:#0f0f0f;"><tr><td align="center" bgcolor="#0f0f0f" style="background:#0f0f0f;padding:0;"><table width="580" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;max-width:580px;width:100%;background:#0f0f0f;color:#fff;">
      ...
      case 'send-decline': {
        ...
        await brevoSend({
          ...
          htmlContent: `<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="background:#0f0f0f;"><tr><td align="center" bgcolor="#0f0f0f" style="background:#0f0f0f;padding:0;"><table width="560" cellpadding="0" cellspacing="0" border="0" bgcolor="#0f0f0f" style="font-family:sans-serif;max-width:560px;width:100%;background:#0f0f0f;color:#fff;padding:32px;"><img src="https://gidgarage.com/banner.PNG" alt="GID Garage" style="width:100%;display:block;height:auto;margin-bottom:24px;"/><h2 style="color:#ef4444;font-size:22px;margin:0 0 8px;">⚠️ Payment Declined</h2><p style="color:#9ca3af;margin:0 0 16px;">Hi ${job.fname}, your payment for ${job.vehicle} was declined${reason ? ': ' + reason : '.'}. Please contact us to update your payment method.</p><p style="color:#4b5563;font-size:11px;margin-top:24px;">Call or text <strong style="color:#9ca3af;">480-757-0476</strong> — GID Garage, Flagstaff AZ</p></div>`,
        });
        return json({ ok: true });
      }
